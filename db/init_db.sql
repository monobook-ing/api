...
-- Currency catalog used for room/booking prices
...
-- ===========================================================================
-- AI / Vector / Chat tables (Layer 2 & 3)
-- ===========================================================================

CREATE EXTENSION IF NOT EXISTS vector;

-- AI provider connections per property (API keys encrypted at rest)
...
-- Chat sessions (guest conversations via widget / AI agents)
